...
var sampleVocabularyBox = document.querySelector('.vocabulary-box#sample');
var innerMain = document.querySelector('main>.inner'); // fetch index

_axios.default.get('./index.json').then(function (_ref) {
  var data = _ref.data;
  data.forEach(function (box) {
    // clone box
    var boxDIV = sampleVocabularyBox.cloneNode(true); // detach from instance

    boxDIV.removeAttribute('id'); // insert properties

    boxDIV.querySelector('#lang').textContent = box.lang;
    boxDIV.querySelector('#title').textContent = box.title;
    boxDIV.querySelector('#creator').textContent = "@".concat(box.creator); // display box

    innerMain.appendChild(boxDIV); // link to query

    boxDIV.addEventListener('click', function () {
      return window.location.href = "query.html?queryPath=".concat(box.path);
    });
  });
});
},{"axios":"../node_modules/axios/index.js"}],"../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
